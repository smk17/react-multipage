...
class YdyMainLayout extends React.Component<any, any> {
  ...
  componentDidMount () {
    ...
    this.setState({
      collapsed: collapsed ? JsonHelper.parseJson(collapsed) : false
    })
  }
  ...
  handleMenuCollapse = collapsed => {
    window.localStorage.setItem('collapsed', JsonHelper.toJson(collapsed))
    this.setState({
      collapsed
    })
  };
  ...
  render () {
    ...
    const { isMobile: mb, title, collapsed, notices, fetchingNotices } = this.state;
